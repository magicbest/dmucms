...
public class EmailControler {
    ...
    public String doSendMail(@RequestParam(value = "sendAll", required = false) String sendAll,
            @RequestParam(value = "EmailAddressee") String EmailAddressee, @RequestParam(value = "EmailSubject") String EmailSubject,
            @RequestParam(value = "EmailContent") String EmailContent, HttpServletRequest request) {
